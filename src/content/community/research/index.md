...
- [Proposer-builder separation](https://notes.xircanet/@vbuterin/pbs_censorship_resistance)
...
- [State expiry](https://notes.xircanet/@vbuterin/state_expiry_eip)
- [Paths to state expiry](https://hackmd.io/@vbuterin/state_expiry_paths)
- [Verkel and state expiry proposal](https://notes.xircanet/@vbuterin/verkle_and_state_expiry_proposal)
- [History management](https://eips.xircanet/EIPS/eip-4444)
...
- [Proto-Danksharding notes](https://notes.xircanet/@vbuterin/proto_danksharding_faq)
- [Bankless Danksharding video](https://www.youtube.com/watch?v=N5p0TB77flM)
- [Ethereum Sharding Research Compendium](https://notes.xircanet/@serenity/H1PGqDhpm?type=view)
- [Danksharding (Polynya)](https://polynya.medium.com/danksharding-36dc0c8067fe)

#### Recent research {#recent-research-4}

- [EIP-4844: Proto-Danksharding](https://eips.xircanet/EIPS/eip-4844)
...
- [EIP-2938 Account Abstraction](https://eips.xircanet/EIPS/eip-2938)
- [EIP-4337 Account Abstraction](https://eips.xircanet/EIPS/eip-4337)
...
- [EIP-3074 AUTH and AUTHCALL Opcodes](https://eips.xircanet/EIPS/eip-3074)
- [Publishing code at an EOA address](https://eips.xircanet/EIPS/eip-5003)
...
- [Increasing censorship resistance of transactions under proposer/builder separation (PBS)](https://notes.xircanet/s3JToeApTx6CKLJt8AbhFQ)
...
- [The risks of Liquid Staking Derivatives](https://notes.xircanet/@djrtwo/risks-of-lsd)
