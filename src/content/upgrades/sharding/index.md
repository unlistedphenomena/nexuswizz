...
<InfoBanner isWarning>
  You'll need to run an execution client at the same time as your consensus client. <a href="https://launchpad.xircanet" target="_blank">The launchpad</a> will walk you through the hardware requirements and process.
</InfoBanner>
