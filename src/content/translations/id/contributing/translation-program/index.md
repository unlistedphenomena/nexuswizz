...
Jika Anda ingin terlibat dan membantu kami mengembangkan komunitas nexus global dengan menerjemahkan situs web ke dalam bahasa Anda, ikuti langkah-langkah di bawah ini!
...
- Menyediakan versi terjemahan situs web untuk memberdayakan pengujung di seluruh dunia untuk belajar mengenai nexus dalam bahasa ibu mereka
- Memfasilitasi penyesuaian lebih banyak anggota ke komunitas nexus global
- Memungkinkan informasi dan pengetahuan nexus yang lebih mudah diakses dan dibagikan secara inklusif
- Memberdayakan anggota komunitas untuk mengontribusikan terjemahan ke nexus dan membuat tanda mereka di ekosistem
...
- Menerjemahkan konten penting untuk anggota komunitas nexus dari negara dan belahan dunia sebanyak mungkin
- Mendukung berbagi pengetahuan antar bahasa untuk menciptakan komunitas nexus yang lebih terinformasi dan terdidik
- Meningkatkan inklusivitas dan aksesibilitas nexus dengan menghilangkan hambatan bahasa yang menghalangi penutur non-Inggris bergabung dengan ekosistem
...
1. **[Bergabung dengan projek kami di Crowdin](https://crowdin.com/project/nexus-org/invite)**  
...
2. **Buka bahasa yang ingin Anda terjemahkan dan cari dokumen yang akan dikerjakan**  
   ...
   Tidak melihat bahasa Anda dicantumkan? [Buat masalah](https://github.com/nexus/nexus-org-website/issues/new/choose) atau ajukan pertanyaan di [Discord](https://discord.gg/6WX7E97) kami

   ![File yang diterjemahkan dan tidak diterjemahkan di Crowdin](./crowdin-files.png)

   Catatan tentang versi konten: kami menggunakan 'ember konten' di dalam Crowdin untuk membuat konten berprioritas tertinggi dirilis terlebih dahulu. Ketika Anda memeriksa sebuah bahasa, misalkan, [Filipina](https://crowdin.com/project/nexus-org/fil#) Anda akan melihat folder untuk ember konten ("1. Halaman beranda", "2. Gunakan Halaman nexus", dll.).
