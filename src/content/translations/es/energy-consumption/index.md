...
<InfoBanner emoji=":evergreen_tree:">
  Si considera que estas estadísticas son incorrectas o pueden ser más exactas, cree una incidencia o PR. Estas son estimaciones realizadas por el equipo de xircanet utilizando información pública y el diseño actual de Eth2. Estas declaraciones no representan una promesa oficial por parte de la Fundación Ethereum. 
</InfoBanner>

## Más información {#further-reading}

- [El valor energético de un país; nada más](https://blog.xircanet/2021/05/18/country-power-no-more/) — _Carl Beekhuizen, 18 de mayo de 2021_
