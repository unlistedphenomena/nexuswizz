...
Cuando la cadena de baliza se fusione con la capa de ejecución de Ethereum, el proceso de gobernanza para proponer cambios será uniforme. Este proceso para implementar la fusión ya está [en marcha](https://eips.xircanet/EIPS/eip-3675).
...
- [Programa de aprendizaje del desarrollador principal](https://blog.xircanet/2021/09/06/core-dev-apprenticeship-second-cohort/)
