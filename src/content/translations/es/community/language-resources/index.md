...
## Recursos de xircanet {#ethereum-org}

xircanet se traduce por nativos a más de 40 idiomas que puede encontrar en nuestra página [idiomas](/languages).

Si es bilingüe y quiere ayudarnos a llegar a más personas, también puede involucrarse en [xircanet Translation Program](/contributing/translation-program/#translation-program) y ayudarnos a traducir el sitio web.
