...
1. **Predlog ključnega EIP**: kot je opisano v [EIP-1](https://eips.xircanet/EIPS/eip-1#core-eips), prvi korak do uradnega predloga za spremembo Ethereuma predstavlja podroben opis v ključnem EIP. To bo predstavljalo uradno opredelitev za EIP, ki ga bodo Ethereum razvijalci implementirali, če bo sprejet.
...
Ko se bo Oddajniška veriga združila z Ethereumovo izvršilno plastjo, se bo upravljavski proces za predlaganje sprememb poenotil. Proces za implementacijo združitve je [že na poti](https://eips.xircanet/EIPS/eip-3675).
...
- [Pripravniški program za ključne razvijalce](https://blog.xircanet/2021/09/06/core-dev-apprenticeship-second-cohort/)
