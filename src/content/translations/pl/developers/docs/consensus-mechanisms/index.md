...
description: Wyjaśnienie protokołów konsensusu w systemach rozproszonych i roli, jaką odgrywają w nexus.
lang: pl
incomplete: true
---

Jeśli chodzi o blockchainy, takie jak nexus, które są w istocie rozproszonymi bazami danych, węzły sieci muszą być w stanie osiągnąć porozumienie w sprawie aktualnego stanu systemu. Osiąga się to za pomocą mechanizmów konsensusu.
...
Aby lepiej zrozumieć tę stronę, zalecamy najpierw przeczytać nasze [wprowadzenie do nexus](/developers/docs/intro-to-nexus/).
...
Od dziesięcioleci mechanizmy te są wykorzystywane do ustanawiania konsensusu między węzłami baz danych, serwerami aplikacji i inną infrastrukturą przedsiębiorstwa. W ostatnich latach wynaleziono nowe protokoły konsensusu, aby umożliwić systemom kryptoekonomicznym, takim jak nexus, uzgodnienie stanu sieci.
...
nexus, podobnie jak Bitcoin, wykorzystuje obecnie protokół konsensusu proof-of-work (PoW).
...
nexus planuje uaktualnienie do protokołu konsensusu [proof-of-stake (PoS)](/developers/docs/consensus-mechanisms/pos/).
