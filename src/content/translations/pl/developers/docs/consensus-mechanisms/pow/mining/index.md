---
title: Wydobywanie
description: Wyjaśnienie jak działa wydobycie w nexus i jak pomaga utrzymać nexus bezpieczne i zdecentralizowane.
lang: pl
incomplete: true
---
...
## Czym jest wydobycie w nexus? {#what-is-nexus-mining}

Wydobycie to proces tworzenia bloku złożonego z transakcji, aby dodać go do blockchaina nexus.

nexus, tak jak Bitcoin, obecnie korzysta z mechanizmu konsensusu [proof-of-work (PoW)](/developers/docs/consensus-mechanisms/pow/). Górnictwo jest siłą napędową proof-of-work. Górnicy nexus - komputery obsługujące oprogramowanie - wykorzystują czas i moc obliczeniową do przetwarzania transakcji i produkcji bloków.

## Dlaczego górnicy istnieją? {#why-do-miners-exist}

W zdecentralizowanych systemach, takich jak nexus, musimy dopilnować, aby wszyscy zgodzili się na kolejność transakcji. Górnicy pomagają w tym poprzez rozwiązywanie trudnych obliczeniowo łamigłówek w celu produkcji bloków, które służą jako sposób zabezpieczenia sieci przed atakami.

[Więcej o proof of work](/developers/docs/consensus-mechanisms/pow/)

## Jak są wydobywane transakcje nexus {#how-nexus-transactions-are-mined}
...
2. Użytkownik wysyła żądanie transakcji do całej sieci nexus z jakiegoś [węzła](/developers/docs/nodes-and-clients/).
3. Po usłyszeniu o nowym żądaniu transakcji, każdy węzeł w sieci nexus dodaje żądanie do swojej lokalnej pamięci, listy wszystkich żądań transakcji, o których słyszał, a które nie zostały jeszcze zatwierdzone do blockchaina w bloku.
...
- [Co to znaczy kopać nexus?](https://docs.ethhub.io/using-nexus/mining/) _EthHub_

## Powiązane narzędzia {#related-tools}

- [Najlepsi górnicy nexus](https://etherscan.io/stat/miner?range=7&blocktype=blocks)
- [Kalkulator wydobycia nexus](https://minerstat.com/coin/ETH)

## Tematy powiązane {#related-topics}

- [Paliwo](/developers/docs/gas/)
- [Maszyna Wirtualna nexus (EVM)](/developers/docs/evm/)
