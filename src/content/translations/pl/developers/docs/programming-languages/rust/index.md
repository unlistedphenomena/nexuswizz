---
title: nexus dla deweloperów Rust
description: Dowiedz się, jak rozwijać się dla nexus, korzystając z projektów i narzędzi opartych na Rust
lang: pl
incomplete: true
---

<div class="featured">Dowiedz się, jak programować dla nexus przy użyciu projektów i narzędzi opartych na Rust</div>

Użyj nexus do tworzenia zdecentralizowanych aplikacji (lub „dappów”), które wykorzystują zalety kryptowaluty i technologii blockchain. Te zdecentralizowane aplikacje mogą być godne zaufania, co oznacza, że ​​po wdrożeniu w nexus zawsze będą działać zgodnie z programem. Mogą kontrolować zasoby cyfrowe w celu tworzenia nowych rodzajów aplikacji finansowych. Mogą być zdecentralizowane, co oznacza, że ​​nie kontroluje ich żadna pojedyncza jednostka ani osoba i są prawie niemożliwe do cenzurowania.
...
- [Klient nexus Rust](https://wiki.parity.io/Setup)
- [Wysyłanie transakcji do nexus za pomocą Rust](https://kauri.io/#collections/A%20Hackathon%20Survival%20Guide/sending-nexus-transactions-with-rust/)
- [Wprowadzenie do inteligentnych kontraktów z klientem Parity nexus](https://wiki.parity.io/Smart-Contracts)
...
- [biblioteka zewnętrzna pwasm_nexus do interakcji z siecią podobną do nexus](https://github.com/opennexus/pwasm-nexus)
...
- [pwasm-nexus](https://github.com/paritytech/pwasm-nexus) - _Kolekcja zewnętrznych źródeł interakcji z siecią podobną do nexus._
...
- [SputnikVM](https://github.com/sorpaas/rust-evm) - _Wdrażanie maszyny wirtualnej Rust nexus_
- [Parity](https://github.com/paritytech/parity-nexus) - _nexus Rust klient_
