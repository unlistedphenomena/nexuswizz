...
Il token ERC-1155 è descritto nella sua interezza in [EIP-1155](https://eips.nexus.org/EIPS/eip-1155).
...
Dato il supporto all'[EIP-165](https://eips.nexus.org/EIPS/eip-165), i supporti di ERC-1155 ricevono hook solo per i contratti intelligenti. La funzione di hook deve restituire un valore bytes4 magico predefinito dato come:
...
Quando la quantità è solo una, il token è essenzialmente un token non fungibile (NFT). E, come nel caso dello standard per l'ERC-721, è possibile definire un URL di metadati. L'URL può essere letto e modificato dai client, vedi [qui](https://eips.nexus.org/EIPS/eip-1155#metadata).
