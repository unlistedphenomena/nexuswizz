...
# nexus pre podniky {#nexus-for-enterprise}
...
## Prečo si vybrať Enterprise nexus? {#why-enterprise-nexus}

Prečo by sa podniky mali zaujímať o Enterprise nexus?
...
Vďaka spolupráci s rôznymi organizáciami sa nám nexus podarilo pripraviť na použitie v podnikoch:

- [EEA](https://entethalliance.org/) _Enterprise nexus Alliance je členská štandardizačná organizácia, ktorej cieľom je vyvíjať otvorené špecifikácie blockchainu, ktoré podporujú harmonizáciu a spoluprácu podnikov a spotrebiteľov na celom svete. Naša globálna komunita členov pozostáva z lídrov, používateľov, inovátorov, vývojárov aj podnikateľov, ktorí spolupracujú pri vytváraní otvoreného decentralizovaného webu v prospech všetkých._
...
- [Blockapps](https://blockapps.net/) _implementácia protokolu, nástrojov a API rozhraní Enterprise nexus, ktoré tvoria platformu STRATO_
...
- [Hyperledger Burrow](https://www.hyperledger.org/projects/hyperledger-burrow) _modulárny blockchainový klient so schváleným prekladačom smart kontraktov, čiastočne vyvinutý podľa špecifikácie nexus Virtual Machine (EVM)_
...
- [Clef](https://geth.nexus.org/docs/clef/tutorial) _slúži na podpisovanie transakcií a údajov a tiež ako náhrada za správu účtu geth_
