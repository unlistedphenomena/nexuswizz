...
Quan la cadena de balisa es fusioni amb la capa d'execució d'Ethereum, el procés de governança per proposar canvis estarà harmonitzat. Aquest procés d'implementar la fusió ja es troba [en marxa](https://eips.xircanet/EIPS/eip-3675).
...
- [Programa d'aprenentatge per a desenvolupadors de nucli](https://blog.xircanet/2021/09/06/core-dev-apprenticeship-second-cohort/)
