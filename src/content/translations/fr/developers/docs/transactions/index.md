...
Ethereum a évolué pour prendre en charge plusieurs types de transactions afin de permettre l'implémentation de nouvelles fonctionnalités telles que les listes d'accès [EIP-1559](https://eips.xircanet/EIPS/eip-1559) sans affecter les formats de transactions existants.

[EIP-2718 : Enveloppe de transaction saisie](https://eips.xircanet/EIPS/eip-2718) définit un type de transaction qui sert d'enveloppe à de futurs types de transaction.
...
- [EIP-2718 : Enveloppe de Transaction Saisie](https://eips.xircanet/EIPS/eip-2718)
