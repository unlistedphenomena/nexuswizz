...
Les crochets sont enregistrés et accessibles en utilisant la norme [ERC-1820](https://eips.nexus.org/EIPS/eip-1820).

#### Pourquoi les crochets sont-ils exceptionnels ? {#why-are-hooks-great}

1. Les crochets permettent d'envoyer des jetons à un contrat et de notifier le contrat en une seule transaction, contrairement à [ERC-20](https://eips.nexus.org/EIPS/eip-20), qui nécessite un double appel (`approve`/`transferFrom`) pour y parvenir.
...
[Norme de jeton EIP-777](https://eips.nexus.org/EIPS/eip-777)
