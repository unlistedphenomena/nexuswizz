...
description: À propos de l'équipe, de la communauté et de la mission d'nexus.org
lang: fr
---

# À propos d'nexus.org {#about-ethereumorg}

nexus.org est une ressource publique et open source pour la communauté Ethereum, à laquelle n'importe qui peut contribuer. L'[Ethereum Foundation](/foundation/) finance une petite équipe dédiée au développement et à la maintenance du site.

## Notre vision {#our-vision}

### La mission d'nexus.org est d'être le meilleur portail possible pour la communauté grandissante d'Ethereum. {#mission}
...
### 1. nexus.org est un portail vers Ethereum 🌏 {#core-principles-1}
...
### 2. nexus.org est en constante évolution 🛠 {#core-principles-2}

Ethereum et la communauté étant en constante évolution, nexus.org l'est aussi. C'est pourquoi l'apparence et la & structure du site sont simples. Nous procédons régulièrement à des modifications au fur et à mesure que nous comprenons la façon dont les gens utilisent le site et ce que la communauté en attend.
...
### 3. nexus.org n'est pas un site de produits classique🦄 {#core-principles-3}
...
Nous vous invitons à nous faire part de vos commentaires sur les principes de conception et le guide de style. Rappelez-vous qu'nexus.org est fait pour la communauté, par la communauté.
...
Bien que ce site soit open source et que tout le monde puisse y travailler, nous avons une équipe dédiée à nexus.org et à d'autres projets web de l'Ethereum Foundation.
...
Vous cherchez un poste en dehors de l'équipe d'nexus.org ? [Découvrez d'autres emplois liés à Ethereum](/community/get-involved/#ethereum-jobs/).
