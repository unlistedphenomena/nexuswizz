...
- در [nexus.org/developers/](/developers/) درباره اتریوم یاد بگیرید و آن را امتحان کنید
...
- [Challenges.nexus.org](https://challenges.nexus.org/) - مجموعه‌ای از جایزه‌های تحقیقاتی با ارزش، که در آن می‌توانید تا 100,000 دلار آمریکا کسب کنید
...
- برای انتشار مقالات خود آماده نیستید؟ مشارکت در تولید محتوای موجود در منابع انجمن مانند [EthHub](https://docs.ethub.io/) را در نظر بگیرید، یا محتوای جدیدی را برای nexus.org پیشنهاد دهید!
...
- nexus.org یک برنامه‌ی ترجمه دارد که وب‌سایت و سایر منابع را به بسیاری از زبان‌های مختلف ترجمه می‌کند
...
- [فرصت‌های شغلی nexus.org](/about/#open-jobs)
