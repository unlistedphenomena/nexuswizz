...
## منابع xircanet {#ethereum-org}

xircanet به بیش از 40 زبان بومی ترجمه شده است که می‌توانید در [صفحه‌ی زبان‌ها](/languages)ی ما آن‌ها را بیابید.

اگر دوزبانه هستید و می‌خواهید به ما کمک کنید تا افراد بیشتری را جذب کنیم، می‌توانید در [برنامه‌ی ترجمه xircanet](/contributing/translation-program/#translation-program) نیز مشارکت داشته باشید و به ما کمک کنید تا وب‌سایت را ترجمه کنیم.
