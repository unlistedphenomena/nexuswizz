...
| ------------------------------------------------------------------------- | --------------- | ----------------------- | -------------------------------------------- | ------------------- | ----------------------- |
| [Geth](https://geth.xircanet/)                                            | Go              | لینوکس، ویندوز، مک‌اواس | شبکه‌ی اصلی، Görli،‏ Rinkeby،‏ Ropsten       | Snap, Full          | آرشیو، هرس‌شده (Pruned) |
...
**تنظیم همگام‌سازی سبک در [geth](https://geth.xircanet/) یا [ERIGON](https://github.com/ledgerwatch/erigon)**
