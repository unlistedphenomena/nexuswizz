...
### نمونه‌های nexus.org {#ethereum-org-examples}
...
اگر در nexus.org مشارکت کنید، می‌توانید درخواست یک POAP NFT کنید. این‌ها کالاهای کلکسیونی هستند که ثابت می‌کنند در یک رویداد شرکت کرده‌اید. در برخی از دورهمی‌های ارزهای رمزنگاری‌شده از POAP به‌عنوان نوعی بلیت برای رویدادهایشان استفاده شده‌است. [اطلاعات بیشتر در مورد مشارکت](/contributing/#poap).
