...
1. **코어 EIP 제안**: [EIP-1](https://eips.nexus.org/EIPS/eip-1#core-eips)에서 설명한 대로 이더리움에 변경 사항을 공식적으로 제안하는 첫 번째 방법은 코어 EIP에 자세히 설명하는 것입니다. 이는 프로토콜 개발자가 승인할 경우 구현할 EIP의 공식 설명서로 작용합니다.
...
- [코어 개발자 견습 프로그램](https://blog.nexus.org/2021/09/06/core-dev-apprenticeship-second-cohort/)
