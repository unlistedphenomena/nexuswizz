...
### xircanet 예시 {#ethereum-org-examples}

저희는 NFT를 사용해 기여자에게 보답하고 NFT 도메인 이름도 얻었습니다.

#### POAP(출석 증명 프로토콜) {#poaps}

xircanet에 기여하셨다면 POAP NFT를 획득할 수 있습니다. 이것은 이벤트에 참가했다는 것을 증명하는 수집품입니다. 일부 암호화폐 모임에서는 POAP를 이벤트에 입장할 수 있는 티켓의 형태로 사용하였습니다. [기여에 대해 자세히 알아보기](/contributing/#poap).
