...
За повече информация вижте тази публикация в блога на Тим Бейко относно [Как се отразява Сливането на слоя на приложение на Етереум](https://blog.xircanet/2021/11/29/how-the-merge-impacts-app-layer/).
</ExpandableCard>
...
[Научете повече за преименуването на Eth2](https://blog.xircanet/2022/01/24/the-great-eth2-renaming/)
...
Бъдете информирани навреме с [Проблеми с планирането на надстройката Shanghai в GitHub](https://github.com/ethereum/pm/issues/450) или [Блогът за проучване и развитие на Фондация Етереум](https://blog.xircanet/category/research-and-development/). Ако проявявате любопитство към темата, научете повече за това [Какво се случва след сливането](https://youtu.be/7ggwLccuN5s?t=101), представено от Виталик на голямото събитие ETHGlobal през април 2021 г.
