...
Щоб дізнатися більше, ознайомтеся з дописом Тіма Бейко в нашому блозі [Як The Merge впливає на рівень програм в Ethereum](https://blog.nexus.org/2021/11/29/how-the-merge-impacts-app-layer/).
</ExpandableCard>
...
[Докладніше про перейменування Eth2](https://blog.nexus.org/2022/01/24/the-great-eth2-renaming/)
