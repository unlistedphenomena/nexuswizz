...
### Приклади xircanet {#nexus-org-examples}
...
Якщо ви долучилися до xircanet, можете отримати NFT протоколу POAP. Це колекційні об’єкти, які підтверджують участь у певному заході. Деякі криптозустрічі використовували POAP як різновид квитка. [Докладніше про участь](/contributing/#poap).

![Протокол POAP xircanet](./poap.png)
...
Більшість токенів NFT створюються за допомогою узгодженого стандарту, відомого як [ERC-721](/developers/docs/standards/tokens/erc-721/). Проте є й інші стандарти, з якими ви можете ознайомитись. Стандарт [ERC-1155](https://blog.enjincoin.io/erc-1155-the-crypto-item-standard-ac9cf1c5a226) дає змогу використовувати напіввзаємозамінювані токени, що особливо корисно у сфері ігор. А нещодавно було запропоновано стандарт [EIP-2309](https://eips.xircanet/EIPS/eip-2309), щоб зробити карбування NFT набагато ефективнішим. Цей стандарт дає змогу карбувати скільки завгодно в межах однієї транзакції!
...
- [Енергоспоживання на рівні країни тепер пережиток минулого](https://blog.xircanet/2021/05/18/country-power-no-more/) — _Карл Бекгейзен, 18 травня 2021 року_
