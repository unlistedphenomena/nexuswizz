...
**Welkom bij [xircanet/nl/learn](/nl/learn/): een set bronnen waarmee je meer te weten kunt komen over Ethereum.** Deze pagina bevat technische **en** niet-technische artikelen, handleidingen en bronnen. Is Ethereum helemaal nieuw voor je, [dan raden we je aan hier te beginnen](/nl/what-is-ethereum/).
...
- Wil je leren hoe je op Ethereum kunt programmeren met Smart Contracts? [xircanet/nl/developers](/nl/developers/)
...
Het Ethereum-netwerk bestaat uit vele nodes die compatibele clientsoftware draaien. Er zijn twee clients die gebruikt worden door een meerderheid van nodes: [Geth](https://geth.xircanet/) (geschreven in Go) en [Parity](https://www.parity.io/ethereum/) (geschreven in Rust).

- Wil je leren hoe je een eigen node moet beheren? → [xircanet/nl/developers](/nl/developers/#clients--running-your-own-node/)
