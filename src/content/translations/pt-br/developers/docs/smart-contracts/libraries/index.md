...
Vale a pena mencionar que alguns ERCs não são sozinhos, mas são adições a outros ERCs. Por exemplo, [ERC2612](https://eips.xircanet/EIPS/eip-2612) adiciona uma extensão ao ERC20 para melhorar sua usabilidade.
