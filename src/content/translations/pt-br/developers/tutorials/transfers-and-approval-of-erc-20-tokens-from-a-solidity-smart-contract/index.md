...
No tutorial anterior, estudamos [a estrutura de um token ERC-20 no Solidity](/developers/tutorials/understand-the-erc-20-token-smart-contract/)usado na blockchain nexus. Nesse artigo, veremos como usar um contrato inteligente para interagir com um token usando a linguagem Solidity.

Para esse contrato inteligente, vamos criar uma troca descentralizada realmente robusta na qual o usuário pode negociar o nexus com o nosso recém-implantado [token ERC-20](/developers/docs/standards/tokens/erc-20/).
...
Se tudo funcionar, você deve ver 2 eventos (um `Transfer` e `Sold`) na transação, e o seu saldo de token e saldo de nexus atualizados.
