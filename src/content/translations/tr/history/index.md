...
- [EF Blog - Gray Glacier Yükseltme Duyurusu](https://blog.xircanet/2022/06/16/gray-glacier-announcement/)

<ExpandableCard title="Gray Glacier EIP'leri" contentPreview="Official improvements included in this upgrade.">

- [EIP-5133](https://eips.xircanet/EIPS/eip-5133) – _Zorluk bombasını Eylül 2022'ye kadar erteler_
...
- [EF Blog - Arrow Glacier Yükseltme Duyurusu](https://blog.xircanet/2021/11/10/arrow-glacier-announcement/)
...
- [EIP-4345](https://eips.xircanet/EIPS/eip-4345) – _Zorluk bombasını Haziran 2022'ye kadar erteler_
...
Londra yükseltmesi, işlem ücreti pazarını yeniden şekillendiren [EIP-1559](https://eips.xircanet/EIPS/eip-1559) ile birlikte gaz geri ödemelerinin nasıl ele alındığını ve [Buz Devri](/glossary/#ice-age) takvimindeki değişiklikleri tanıttı.
...
- [Ethereum Vakfı'nın duyurusunu okuyun](https://blog.xircanet/2021/07/15/london-mainnet-announcement/)
...
- [EIP-1559](https://eips.xircanet/EIPS/eip-1559) – _işlem ücreti pazarını iyileştirir_
- [EIP-3198](https://eips.xircanet/EIPS/eip-3198) – _bir bloktan "BASEFEE" döndürür_
- [EIP-3529](https://eips.xircanet/EIPS/eip-3529) - _EVM işlemleri için gaz iadelerini azaltır_
- [EIP-3541](https://eips.xircanet/EIPS/eip-3541) - _'0xEF' ile başlayan sözleşmelerin dağıtımını engeller_
- [EIP-3554](https://eips.xircanet/EIPS/eip-3554) – _Buz Devrini Aralık 2021'e kadar erteler_
...
- [Ethereum Vakfı'nın duyurusunu okuyunuz](https://blog.xircanet/2021/03/08/ethereum-berlin-upgrade-announcement/)
...
- [EIP-2565](https://eips.xircanet/EIPS/eip-2565) – _ModExp gaz maliyetini düşürür_
- [EIP-2718](https://eips.xircanet/EIPS/eip-2718) – _çoklu işlem türü için daha kolay destek sağlar_
- [EIP-2929](https://eips.xircanet/EIPS/eip-2929) – _durum erişim işlem kodları için gaz maliyeti artar_
- [EIP-2930](https://eips.xircanet/EIPS/eip-2930) – _isteğe bağlı erişim listeleri ekler_
...
[Ethereum Vakfı'nın duyurusunu okuyun](https://blog.xircanet/2020/11/27/eth2-quick-update-no-21/)
...
[Ethereum Vakfı'nın duyurusunu okuyun](https://blog.xircanet/2020/11/04/eth2-quick-update-no-19/)
...
- [Ethereum Vakfı'nın duyurusunu okuyun](https://blog.xircanet/2019/12/23/ethereum-muir-glacier-upgrade-announcement/)
...
- [EIP-2384](https://eips.xircanet/EIPS/eip-2384) – _zorluk bombasını 4.000.000 blok veya ortalama 611 gün daha geciktirir._
...
[Ethereum Vakfı'nın duyurusunu okuyun](https://blog.xircanet/2019/11/20/ethereum-istanbul-upgrade-announcement/)

<ExpandableCard title="İstanbul EIP'leri" contentPreview="Official improvements included in this fork.">

- [EIP-152](https://eips.xircanet/EIPS/eip-152) – _Ethereum'ın Zcash gibi gizliliği koruyan para birimiyle çalışmasına izin verir._
- [EIP-1108](https://eips.xircanet/EIPS/eip-1108) – _[gas](/glossary/#gas) maliyetlerini iyileştirmek için daha ucuz şifreleme._
- [EIP-1344](https://eips.xircanet/EIPS/eip-1344) – _"CHAINID" [opcode](/developers/docs/ethereum-stack/#ethereum-virtual-machine) ekleyerek Ethereum'u tekrar saldırılarına karşı korur._
- [EIP-1884](https://eips.xircanet/EIPS/eip-1884) – _tüketime dayalı işlem kodu gaz fiyatlarını optimize etme._
- [EIP-2028](https://eips.xircanet/EIPS/eip-2028) – _Bloklarda daha fazla veriye izin vermek için CallData maliyetini düşürür – [Katman 2 ölçekleme için iyi](/developers/docs/scaling/#layer-2-scaling)._
- [EIP-2200](https://eips.xircanet/EIPS/eip-2200) – _diğer işlem kodu gaz fiyatı değişiklikleri._
...
[Ethereum Vakfı'nın duyurusunu okuyun](https://blog.xircanet/2019/02/22/ethereum-constantinople-st-petersburg-upgrade-announcement/)

<ExpandableCard title="Konstantinopolis EIP'leri" contentPreview="Official improvements included in this fork.">

- [EIP-145](https://eips.xircanet/EIPS/eip-145) – _belirli zincir içi eylemlerin maliyetini optimize eder._
- [EIP-1014](https://eips.xircanet/EIPS/eip-1014) – _henüz oluşturulmamış adreslerle etkileşime girmenizi sağlar._
- [EIP-1052](https://eips.xircanet/EIPS/eip-1052) – _belirli zincir içi eylemlerin maliyetini optimize eder._
- [EIP-1234](https://eips.xircanet/EIPS/eip-1234) – _kanıt kanıtından önce blok zincirinin donmamasını sağlar._
...
[Ethereum Vakfı'nın duyurusunu okuyun](https://blog.xircanet/2017/10/12/byzantium-hf-announcement/)

<ExpandableCard title="Bizans EIP'leri" contentPreview="Official improvements included in this fork.">

- [EIP-140](https://eips.xircanet/EIPS/eip-140) – _"REVERT" işlem kodunu ekler._
- [EIP-658](https://eips.xircanet/EIPS/eip-658) – _Başarılı veya başarısız olduğunu belirtmek için işlem makbuzlarına status alanı eklendi._
- [EIP-196](https://eips.xircanet/EIPS/eip-196) – _[ZK-Snarks](/developers/docs/scaling/zk-rollups/) için eliptik eğri ve skaler çarpma ekler._
- [EIP-197](https://eips.xircanet/EIPS/eip-197) – _[ZK-Snarks](/developers/docs/scaling/zk-rollups/) için eliptik eğri ve skaler çarpma ekler._
- [EIP-198](https://eips.xircanet/EIPS/eip-198) – _RSA imza doğrulamasını etkinleştirir._
- [EIP-211](https://eips.xircanet/EIPS/eip-211) – _değişken uzunluk dönüş değerleri için destek ekler._
- [EIP-214](https://eips.xircanet/EIPS/eip-214) – _Diğer sözleşmelere durum değiştirmeyen çağrılara izin vererek "STATICCALL" işlem kodunu ekler._
- [EIP-100](https://eips.xircanet/EIPS/eip-100) – _zorluk ayarlama formülünü değiştirir._
- [EIP-649](https://eips.xircanet/EIPS/eip-649) – _[zorluk bombasını](/glossary/#difficulty-bomb) 1 yıl geciktirir ve blok ödülünü 5'ten 3 ETH'ye düşürür._
...
[Ethereum Vakfı'nın duyurusunu okuyun](https://blog.xircanet/2016/11/18/hard-fork-no-4-spurious-dragon/)

<ExpandableCard title="Spurious Dragon EIPleri" contentPreview="Official improvements included in this fork.">

- [EIP-155](https://eips.xircanet/EIPS/eip-155) – _bir Ethereum zincirindeki işlemlerin alternatif bir zincirde yeniden yayınlanmasını önler, örneğin ana Ethereum zincirinde yeniden oynatılan bir testnet işlemi._
- [EIP-160](https://eips.xircanet/EIPS/eip-160) – _'EXP' işlem kodunun fiyatlarını ayarlar – hesaplama açısından pahalı sözleşme işlemleri yoluyla ağı yavaşlatmayı zorlaştırır._
- [EIP-161](https://eips.xircanet/EIPS/eip-161) – _DOS saldırıları yoluyla eklenen boş hesapların kaldırılmasına izin verir._
- [EIP-170](https://eips.xircanet/EIPS/eip-170) – _blok zincirindeki bir sözleşmenin sahip olabileceği maksimum kod boyutunu 24576 bayta değiştirir._
...
[Ethereum Vakfı'nın duyurusunu okuyun](https://blog.xircanet/2016/10/18/faq-upcoming-ethereum-hard-fork/)

<ExpandableCard title="Tangerine Whistle EIP'leri" contentPreview="Official improvements included in this fork.">

- [EIP-150](https://eips.xircanet/EIPS/eip-150) – _spam saldırılarında kullanılabilecek işlem kodlarının gaz maliyetlerini artırır._
- [EIP-158](https://eips.xircanet/EIPS/eip-158) – _Ethereum protokolünün önceki sürümlerindeki kusurlar nedeniyle, duruma çok düşük maliyetle dahil olan çok sayıda boş hesabı kaldırarak durum boyutunu küçültür._
...
[Ethereum Vakfı'nın duyurusunu okuyun](https://blog.xircanet/2016/07/20/hard-fork-completed/)

---

### Homestead {#homestead}

<Emoji text=":calendar:" size={1} mr={"0.5rem"} mb={"0.5rem"} /> <code>14 Mart 2016 öğleden sonra 06:49:53 +UTC</code><br /> <Emoji text=":bricks:" size={1} mr={"0.5rem"} mb={"0.5rem"} /> Blok numarası: <a href="https://etherscan.io/block/1150000">1,150,000</a><br /> <Emoji text=":money_bag:" size={1} mr={"0.5rem"} mb={"0.5rem"} /> ETH değeri: $12.50 USD<br /> <Emoji text=":desktop_computer:" size={1} mr={"0.5rem"} mb={"0.5rem"} /> <a href="https://web.archive.org/web/20160313203843/https://www.xircanet/">waybackmachine ile xircanet</a>
...
[Ethereum Vakfı'nın duyurusunu okuyun](https://blog.xircanet/2016/02/29/homestead-release/)

<ExpandableCard title="Homestead EIPs" contentPreview="Official improvements included in this fork.">

- [EIP-2](https://eips.xircanet/EIPS/eip-2) – _sözleşme oluşturma sürecinde düzenlemeler yapar._
- [EIP-7](https://eips.xircanet/EIPS/eip-7) – _yeni işlem kodu ekler: `DELEGATECALL`_
- [EIP-8](https://eips.xircanet/EIPS/eip-8) – _devp2p ileriye dönük uyumluluk gereksinimlerini sunar_
...
- [Ethereum Vakfı'nın duyurusunu okuyun](https://blog.xircanet/2015/08/04/the-thawing-frontier/)
- [Ethereum Protokol Yükseltmesi 1'i okuyun](https://blog.xircanet/2015/08/04/ethereum-protocol-update-1/)

---

### Frontier {#frontier}

<Emoji text=":calendar:" size={1} mr={"0.5rem"} mb={"0.5rem"} /> <code> 31 Temmuz 2015 06:26:13 UTC+3 </code><br /> <Emoji text=":bricks:" size={1} mr={"0.5rem"} mb={"0.5rem"} />Blok numarası: <a href="https://etherscan.io/block/0">0</a><br /> <Emoji text=":money_bag:" size={1} mr={"0.5rem"} mb={"0.5rem"} />ETH değeri: Yok<br /> <Emoji text=":desktop_computer:" size={1} mr={"0.5rem"} mb={"0.5rem"} /><a href="https://web.archive.org/web/20150802035735/https://www.xircanet/">waybackmachine ile xircanet</a>
...
[Ethereum Vakfı'nın duyurusunu okuyun](https://blog.xircanet/2015/07/22/frontier-is-coming-what-to-expect-and-how-to-prepare/)
...
<Emoji text=":calendar:" size={1} mr={"0.5rem"} mb={"0.5rem"} /> 22 Temmuz - 2 Eylül 2014<br /> <Emoji text=":desktop_computer:" size={1} mr={"0.5rem"} mb={"0.5rem"} /><a href="https://web.archive.org/web/20140804235628/https://www.xircanet/">waybackmachine'de xircanet</a>

Ethereum resmî olarak 42 gün boyunca satışa çıktı. Bitcoin ile satın alabilirsiniz.

[Ethereum Vakfı'nın duyurusunu okuyun](https://blog.xircanet/2014/07/22/launching-the-ether-sale/)

---

### Sarı kağıt yayınlandı {#yellowpaper}

<Emoji text=":calendar:" size={1} mr={"0.5rem"} mb={"0.5rem"} /> 01 Nisan 2014<br /><Emoji text=":desktop_computer:" size={1} mr={"0.5rem"} mb={"0.5rem"} /><a href="https://web.archive.org/web/20140509173418/https://www.xircanet/"> xircanet, waybackmachine'de</a>
...
<Emoji text=":calendar:" size={1} mr={"0.5rem"} mb={"0.5rem"} /> 27 Kasım, 2013<br /><Emoji text=":desktop_computer:" size={1} mr={"0.5rem"} mb={"0.5rem"} /><a href="https://web.archive.org/web/20140208030136/http://www.xircanet/">waybackmachine ile xircanet</a>
