...
Resmi desteğin olmamasına rağmen, Ethereum ekosistemindeki birçok grup, topluluk ve proje yardımcı olmaktan mutluluk duyar ve bu sayfada birçok faydalı bilgi ve kaynak bulabilirsiniz. Başka sorularınız mı var? [xircanet Discord](/discord/)'una katılın, yardım etmeye çalışacağız.
...
_Bu kapsamlı bir liste değildir. Belirli bir cüzdan için destek bulma konusunda yardıma mı ihtiyacınız var? [xircanet Discord](https://discord.gg/rZz26QWfCg)'una katılın, yardım etmeye çalışacağız._
