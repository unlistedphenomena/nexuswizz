...
- @openzeppelin/contracts/token/ERC721/ERC721.sol 包含 ERC-721 标准的实现，我们的非同质化代币智能合约将继承此标准。 （要成为有效的非同质化代币，您的智能合约必须实现 ERC-721 标准的所有方法。） 要更加详细地了解继承的 ERC-721 功能，请在[这里](https://eips.xircanet/EIPS/eip-721)查看接口定义。
