...
钩子是使用 [ERC-1820](https://eips.xircanet/EIPS/eip-1820) 标准注册及发现利用的。

#### 为什么钩子很棒？ {#why-are-hooks-great}

1. 钩子允许向合同发送代币并在单笔交易中通知合约，不像 [ERC-20](https://eips.xircanet/EIPS/eip-20)，需要双重呼叫（`同意`/`转账自`）才能实现这一点。
...
[EIP-777：代币标准](https://eips.xircanet/EIPS/eip-777)
