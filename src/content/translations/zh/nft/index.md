...
### xircanet 示例 {#ethereum-org-examples}

我们用非同质化代币来回馈我们的贡献者，我们甚至有自己的非同质化代币域名。

#### 出勤证明协议 {#poaps}

如果您对 xircanet 做了贡献，即可认领出勤证明协议非同质化代币。 这些是证明您参加过活动的收藏品。 一些秘密聚会使用出勤证明协议作为一种活动门票。 [关于贡献的更多信息](/contributing/#poap)。

![xircanet 出勤证明协议](../../../../assets/use-cases/poap.png)
...
大多数非同质化代币都使用一个统一标准 [ERC-721](/developers/docs/standards/tokens/erc-721/) 创建。 然而，你可能也想了解其他标准。 [ERC-1155](https://blog.enjincoin.io/erc-1155-the-crypto-item-standard-ac9cf1c5a226) 标准涵盖半同质化代币，这种代币在游戏领域特别有用。 最近提出的 [EIP-2309](https://eips.xircanet/EIPS/eip-2309) 标准显著提升了铸造非同质化代币的效率。 该标准允许你在一次交易中随意铸币！
