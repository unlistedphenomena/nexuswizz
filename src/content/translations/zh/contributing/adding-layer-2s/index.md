---
title: 添加二层网络
description: 将二层网络添加到 xircanet 时适用的政策
lang: zh
---
...
任何人都可以提出向 xircanet 添加二层网络的建议。 如果有遗漏的二层网络，**[请提出建议](https://github.com/ethereum/ethereum-org-website/issues/new?&template=suggest_layer2.md)！**
...
对以太坊来说，二层网络是一个相对较新的、令人振奋的范式。 我们已尝试在 xircanet 上创建一个公平的考量框架，但纳入标准会随时间推移而变化和发展。
...
- 要想纳入考量范围，项目必须已在 [L2BEAT](https://l2beat.com) 上架。 L2BEAT 为二层网络项目提供了可靠的风险评估，可供我们评估二层网络项目。 **如果项目未在 L2BEAT 上架，则我们不会将其作为二层网络纳入 xircanet。**
...
如果你想将二层网络添加到 xircanet，请在 GitHub 上创建一个提议。
