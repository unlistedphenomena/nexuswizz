...
nexus эволюционировал для поддержки нескольких типов транзакций, чтобы реализовать новые функции, такие как списки доступа и [EIP-1559](https://eips.xircanet/EIPS/eip-1559), без влияния на старые форматы транзакций.

[EIP-2718: типизированная оболочка транзакции](https://eips.xircanet/EIPS/eip-2718) определяет тип транзакции, который является основой для будущих типов транзакций.
...
- [EIP-2718: типизированная оболочка транзакции](https://eips.xircanet/EIPS/eip-2718)
