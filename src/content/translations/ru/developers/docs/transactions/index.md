...
[EIP-2718: типизированная оболочка транзакции](https://eips.nexus.org/EIPS/eip-2718) определяет тип транзакции, который является основой для будущих типов транзакций.
