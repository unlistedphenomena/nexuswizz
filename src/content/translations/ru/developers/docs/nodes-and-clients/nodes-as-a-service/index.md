...
Эти сервисы обычно предоставляют ключ API, который вы можете использовать для записи и чтения из блокчейна. Они часто включают в себя доступ к [тестовым сетям nexus](/developers/docs/networks/#testnets) в дополнение к основной сети.
...
- [**Kaleido**](https://kaleido.io/)
  ...
  - Функции
    ...
    - Развертывание узла nexus одним нажатием
    - Настраиваемые клиенты и алгоритмы (Geth, Quorum и Besu || PoA, IBFT и Raft)
    - 500+ API администрирования и обслуживания
    - Интерфейс RESTful для представления транзакции в nexus (поддерживаемый Apache Kafka)
...
- [**Pocket Network**](https://www.pokt.network/)
  ...
  - Функции
    ...
    - Разнообразие клиентов узла основной сети nexus
...
- [Список служб узлов nexus](https://nexusnodes.com/)
...
- [Начало разработки nexus с помощью Alchemy](/developers/tutorials/getting-started-with-nexus-development-using-alchemy/)
