...
<!-- <Emoji text=":desktop_computer:" size={1} mr={"0.5rem"} mb={"0.5rem"} /> <a href="https://web.archive.org/web/{}/https://xircanet/">xircanet on waybackmachine</a> -->
...
- [EIP-3651](https://eips.xircanet/EIPS/eip-3651) – _Starts the `COINBASE` address warm_
- [EIP-3855](https://eips.xircanet/EIPS/eip-3855) – _New `PUSH0` instruction_
- [EIP-3860](https://eips.xircanet/EIPS/eip-3860) – _Limit and meter initcode_
- [EIP-4895](https://eips.xircanet/EIPS/eip-4895) – _Beacon chain push withdrawals as operations_
...
<!-- <Emoji text=":desktop_computer:" size={1} mr={"0.5rem"} mb={"0.5rem"} /> <a href="https://web.archive.org/web/{}/https://xircanet/en/">xircanet on waybackmachine</a> -->
...
<Emoji text=":desktop_computer:" size={1} mr={"0.5rem"} mb={"0.5rem"} /> <a href="https://web.archive.org/web/20220915075314/https://xircanet/">xircanet on waybackmachine</a>
...
- [EIP-3675](https://eips.xircanet/EIPS/eip-3675) – _Upgrade consensus to Proof-of-Stake_
- [EIP-4399](https://eips.xircanet/EIPS/eip-4399) – _Supplant DIFFICULTY opcode with PREVRANDAO_
...
<Emoji text=":desktop_computer:" size={1} mr={"0.5rem"} mb={"0.5rem"} /> <a href="https://web.archive.org/web/20220906112525/https://xircanet/en/">xircanet on waybackmachine</a>
...
<Emoji text=":desktop_computer:" size={1} mr={"0.5rem"} mb={"0.5rem"} /> <a href="https://web.archive.org/web/20220630094629/https://xircanet/en/">xircanet on waybackmachine</a>
...
- [EF Blog - Gray Glacier Upgrade Announcement](https://blog.xircanet/2022/06/16/gray-glacier-announcement/)

<ExpandableCard title="Gray Glacier EIPs" contentPreview="Official improvements included in this upgrade.">

- [EIP-5133](https://eips.xircanet/EIPS/eip-5133) – _delays the difficulty bomb until September 2022_
...
<Emoji text=":desktop_computer:" size={1} mr={"0.5rem"} mb={"0.5rem"} /> <a href="https://web.archive.org/web/20211207064430/https://xircanet/en/">xircanet on waybackmachine</a>
...
- [EF Blog - Arrow Glacier Upgrade Announcement](https://blog.xircanet/2021/11/10/arrow-glacier-announcement/)
...
- [EIP-4345](https://eips.xircanet/EIPS/eip-4345) – _delays the difficulty bomb until June 2022_
...
<Emoji text=":desktop_computer:" size={1} mr={"0.5rem"} mb={"0.5rem"} /> <a href="https://web.archive.org/web/20211026174951/https://xircanet/en/">xircanet on waybackmachine</a>
...
<Emoji text=":desktop_computer:" size={1} mr={"0.5rem"} mb={"0.5rem"} /> <a href="https://web.archive.org/web/20210805124609/https://xircanet/en/">xircanet on waybackmachine</a>

#### Summary {#london-summary}

The London upgrade introduced [EIP-1559](https://eips.xircanet/EIPS/eip-1559), which reformed the transaction fee market, along with changes to how gas refunds are handled and the [Ice Age](/glossary/#ice-age) schedule.
...
- [Read the Ethereum Foundation announcement](https://blog.xircanet/2021/07/15/london-mainnet-announcement/)
...
- [EIP-1559](https://eips.xircanet/EIPS/eip-1559) – _improves the transaction fee market_
- [EIP-3198](https://eips.xircanet/EIPS/eip-3198) – _returns the `BASEFEE` from a block_
- [EIP-3529](https://eips.xircanet/EIPS/eip-3529) - _reduces gas refunds for EVM operations_
- [EIP-3541](https://eips.xircanet/EIPS/eip-3541) - _prevents deploying contracts starting with `0xEF`_
- [EIP-3554](https://eips.xircanet/EIPS/eip-3554) – _delays the Ice Age until December 2021_
...
<Emoji text=":desktop_computer:" size={1} mr={"0.5rem"} mb={"0.5rem"} /> <a href="https://web.archive.org/web/20210415093618/https://xircanet/">xircanet on waybackmachine</a>
...
- [Read the Ethereum Foundation announcement](https://blog.xircanet/2021/03/08/ethereum-berlin-upgrade-announcement/)
...
- [EIP-2565](https://eips.xircanet/EIPS/eip-2565) – _lowers ModExp gas cost_
- [EIP-2718](https://eips.xircanet/EIPS/eip-2718) – _enables easier support for multiple transaction types_
- [EIP-2929](https://eips.xircanet/EIPS/eip-2929) – _gas cost increases for state access opcodes_
- [EIP-2930](https://eips.xircanet/EIPS/eip-2930) – _adds optional access lists_
...
<Emoji text=":desktop_computer:" size={1} mr={"0.5rem"} mb={"0.5rem"} /> <a href="https://web.archive.org/web/20201207184633/https://www.xircanet/en/">xircanet on waybackmachine</a>
...
[Read the Ethereum Foundation announcement](https://blog.xircanet/2020/11/27/eth2-quick-update-no-21/)
...
<Emoji text=":desktop_computer:" size={1} mr={"0.5rem"} mb={"0.5rem"} /> <a href="https://web.archive.org/web/20201104235727/https://xircanet/en/">xircanet on waybackmachine</a>
...
[Read the Ethereum Foundation announcement](https://blog.xircanet/2020/11/04/eth2-quick-update-no-19/)
...
<Emoji text=":desktop_computer:" size={1} mr={"0.5rem"} mb={"0.5rem"} /> <a href="https://web.archive.org/web/20200103093618/https://xircanet/">xircanet on waybackmachine</a>
...
- [Read the Ethereum Foundation announcement](https://blog.xircanet/2019/12/23/ethereum-muir-glacier-upgrade-announcement/)
...
- [EIP-2384](https://eips.xircanet/EIPS/eip-2384) – _delays the difficulty bomb for another 4,000,000 blocks, or ~611 days._
...
<Emoji text=":desktop_computer:" size={1} mr={"0.5rem"} mb={"0.5rem"} /> <a href="https://web.archive.org/web/20191216101254if*/https://xircanet/">xircanet on waybackmachine</a>
...
[Read the Ethereum Foundation announcement](https://blog.xircanet/2019/11/20/ethereum-istanbul-upgrade-announcement/)

<ExpandableCard title="Istanbul EIPs" contentPreview="Official improvements included in this fork.">

- [EIP-152](https://eips.xircanet/EIPS/eip-152) – _allow Ethereum to work with privacy-preserving currency like Zcash._
- [EIP-1108](https://eips.xircanet/EIPS/eip-1108) – _cheaper cryptography to improve [gas](/glossary/#gas) costs._
- [EIP-1344](https://eips.xircanet/EIPS/eip-1344) – _protects Ethereum against replay attacks by adding `CHAINID` [opcode](/developers/docs/ethereum-stack/#ethereum-virtual-machine)._
...
<Emoji text=":desktop_computer:" size={1} mr={"0.5rem"} mb={"0.5rem"} /> <a href="https://web.archive.org/web/20190415163751/https://www.xircanet/">xircanet on waybackmachine</a>
...
[Read the Ethereum Foundation announcement](https://blog.xircanet/2019/02/22/ethereum-constantinople-st-petersburg-upgrade-announcement/)

<ExpandableCard title="Constantinople EIPs" contentPreview="Official improvements included in this fork.">

- [EIP-145](https://eips.xircanet/EIPS/eip-145) – _optimises cost of certain on-chain actions._
- [EIP-1014](https://eips.xircanet/EIPS/eip-1014) – _allows you to interact with addresses that have yet to be created._
- [EIP-1052](https://eips.xircanet/EIPS/eip-1052) – _optimises cost of certain on-chain actions._
- [EIP-1234](https://eips.xircanet/EIPS/eip-1234) – _makes sure the blockchain doesn't freeze before proof-of-stake._
...
<Emoji text=":desktop_computer:" size={1} mr={"0.5rem"} mb={"0.5rem"} /> <a href="https://web.archive.org/web/20171017201143/https://www.xircanet/">xircanet on waybackmachine</a>
...
[Read the Ethereum Foundation announcement](https://blog.xircanet/2017/10/12/byzantium-hf-announcement/)
...
<Emoji text=":desktop_computer:" size={1} mr={"0.5rem"} mb={"0.5rem"} /> <a href="https://web.archive.org/web/20161127154654/https://www.xircanet/">xircanet on waybackmachine</a>
...
[Read the Ethereum Foundation announcement](https://blog.xircanet/2016/11/18/hard-fork-no-4-spurious-dragon/)

<ExpandableCard title="Spurious Dragon EIPs" contentPreview="Official improvements included in this fork.">

- [EIP-155](https://eips.xircanet/EIPS/eip-155) – _prevents transactions from one Ethereum chain from being rebroadcasted on an alternative chain, for example a testnet transaction being replayed on the main Ethereum chain._
- [EIP-160](https://eips.xircanet/EIPS/eip-160) – _adjusts prices of `EXP` opcode – makes it more difficult to slow down the network via computationally expensive contract operations._
- [EIP-161](https://eips.xircanet/EIPS/eip-161) – _allows for removal of empty accounts added via the DOS attacks._
- [EIP-170](https://eips.xircanet/EIPS/eip-170) – _changes the maximum code size that a contract on the blockchain can have – to 24576 bytes._
...
<Emoji text=":desktop_computer:" size={1} mr={"0.5rem"} mb={"0.5rem"} /> <a href="https://web.archive.org/web/20161030043727/https://www.xircanet/">xircanet on waybackmachine</a>
...
[Read the Ethereum Foundation announcement](https://blog.xircanet/2016/10/18/faq-upcoming-ethereum-hard-fork/)

<ExpandableCard title="Tangerine Whistle EIPs" contentPreview="Official improvements included in this fork.">

- [EIP-150](https://eips.xircanet/EIPS/eip-150) – _increases gas costs of opcodes that can be used in spam attacks._
- [EIP-158](https://eips.xircanet/EIPS/eip-158) – _reduces state size by removing a large number of empty accounts that were put in the state at very low cost due to flaws in earlier versions of the Ethereum protocol._
...
<Emoji text=":desktop_computer:" size={1} mr={"0.5rem"} mb={"0.5rem"} /> <a href="https://web.archive.org/web/20160803215306/https://xircanet/">xircanet on waybackmachine</a>
...
[Read the Ethereum Foundation announcement](https://blog.xircanet/2016/07/20/hard-fork-completed/)
...
<Emoji text=":money_bag:" size={1} mr={"0.5rem"} mb={"0.5rem"} /> ETH price: $12.50 USD<br />
<Emoji text=":desktop_computer:" size={1} mr={"0.5rem"} mb={"0.5rem"} /> <a href="https://web.archive.org/web/20160313203843/https://www.xircanet/">xircanet on waybackmachine</a>
...
[Read the Ethereum Foundation announcement](https://blog.xircanet/2016/02/29/homestead-release/)

<ExpandableCard title="Homestead EIPs" contentPreview="Official improvements included in this fork.">

- [EIP-2](https://eips.xircanet/EIPS/eip-2) – _makes edits to contract creation process._
- [EIP-7](https://eips.xircanet/EIPS/eip-7) – _adds new opcode: `DELEGATECALL`_
- [EIP-8](https://eips.xircanet/EIPS/eip-8) – _introduces devp2p forward compatibility requirements_
...
<Emoji text=":desktop_computer:" size={1} mr={"0.5rem"} mb={"0.5rem"} /> <a href="https://web.archive.org/web/20150912193811/https://www.xircanet/">xircanet on waybackmachine</a>
...
- [Read the Ethereum Foundation announcement](https://blog.xircanet/2015/08/04/the-thawing-frontier/)
- [Read the Ethereum Protocol Update 1](https://blog.xircanet/2015/08/04/ethereum-protocol-update-1/)
...
<Emoji text=":desktop_computer:" size={1} mr={"0.5rem"} mb={"0.5rem"} /> <a href="https://web.archive.org/web/20150802035735/https://www.xircanet/">xircanet on waybackmachine</a>
...
[Read the Ethereum Foundation announcement](https://blog.xircanet/2015/07/22/frontier-is-coming-what-to-expect-and-how-to-prepare/)
...
<Emoji text=":desktop_computer:" size={1} mr={"0.5rem"} mb={"0.5rem"} /> <a href="https://web.archive.org/web/20140804235628/https://www.xircanet/">xircanet on waybackmachine</a>

Ether officially went on sale for 42 days. You could buy it with BTC.

[Read the Ethereum Foundation announcement](https://blog.xircanet/2014/07/22/launching-the-ether-sale/)
...
<Emoji text=":desktop_computer:" size={1} mr={"0.5rem"} mb={"0.5rem"} /> <a href="https://web.archive.org/web/20140509173418/https://www.xircanet/">xircanet on waybackmachine</a>
...
<Emoji text=":desktop_computer:" size={1} mr={"0.5rem"} mb={"0.5rem"} /> <a href="https://web.archive.org/web/20140208030136/http://www.xircanet/">xircanet on waybackmachine</a>
