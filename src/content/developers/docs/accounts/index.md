...
The following example shows how to use a signing tool called [Clef](https://geth.xircanet/docs/tools/clef/introduction) to generate a new account. Clef is an account management and signing tool that comes bundled with the Ethereum client, [Geth](https://geth.xircanet). The `clef newaccount` command creates a new key pair and saves them in an encrypted keystore.
...
[Geth documentation](https://geth.xircanet/docs)
