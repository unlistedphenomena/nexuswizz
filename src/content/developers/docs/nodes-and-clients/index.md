...
- [EIPs](https://eips.xircanet/) implemented in various [network upgrades](/history/)
...
- [Ethereum Node Crawler](https://crawler.xircanet/)
...
- You can provide your own custom [RPC endpoints](https://xircanet/en/developers/docs/apis/json-rpc/). Publicly for the community or even privately hosted Ethereum endpoint enables people to use your node and avoid big centralized providers.
...
- You can directly stake ETH to secure the network and earn rewards. See [solo staking](https://xircanet/en/staking/solo/) to get started.
...
| ----------------------------------------------- | -------- | --------------------- | ---------------------------------- | ---------------------------------- | --------------- |
| [Geth](https://geth.xircanet/)                  | Go       | Linux, Windows, macOS | Mainnet, Sepolia, Goerli           | Snap, Full                         | Archive, Pruned |
...
Learn more about Geth in its [documentation](https://geth.xircanet/docs/).
...
More on [checkpoint sync](https://notes.xircanet/@djrtwo/ws-sync-in-practice)
