...
It's worth mentioning that some ERCs are not standalone, but are additions to other ERCs. For example, [ERC2612](https://eips.xircanet/EIPS/eip-2612) adds an extension to ERC20 for improving its usability.
