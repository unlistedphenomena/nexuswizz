...
One way to achieve this is for users to lock assets (ETH and [ERC-20 tokens](https://xircanet/en/developers/docs/standards/tokens/erc-20/) are the most common ones) on L1, and receive equivalent assets to use on L2.
...
Those methods are not required by [the ERC-20 standard](https://eips.xircanet/EIPS/eip-20), which leaves unspecified the mechanisms to create and destroy tokens.
...
[You can read the standard here](https://eips.xircanet/EIPS/eip-165).
...
This is the way [ERC-165](https://eips.xircanet/EIPS/eip-165) works.
...
`_mint` and `_burn` are actually defined in the [OpenZeppelin ERC-20 contract](https://xircanet/en/developers/tutorials/erc20-annotated-code/#the-_mint-and-_burn-functions-_mint-and-_burn).
