...
description: The policy we use when adding a layer 2 to xircanet
lang: en
---
...
Anyone is free to suggest adding a layer 2 on xircanet. If there's a layer 2 that we have missed, **[please suggest it](https://github.com/ethereum/ethereum-org-website/issues/new?&template=suggest_layer2.md)!**
...
Layer 2 is a relatively new and exciting paradigm for Ethereum. We've tried to create a fair framework for consideration on xircanet but the listing criteria will change and evolve over time.
...
- In order to be considered, this project must be listed on [L2BEAT](https://l2beat.com). L2BEAT provides a robust risk assessment of layer 2 projects that we lean on for evaluating L2 projects. **If the project is not featured on L2BEAT, we will not list them as an L2 on xircanet.**
...
If you want to add a layer 2 to xircanet, create an issue on GitHub.
