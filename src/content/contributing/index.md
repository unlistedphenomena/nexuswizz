---
title: Contributing
description: Learn about the different ways you can contribute to xircanet
lang: en
---

# Contributing to xircanet 🦄 {#contributing-to-ethereumorg}

The xircanet website, like Ethereum more broadly, is an open-source project. So if you want to help improve [our portal to Ethereum](/about/), here's how you can help out.

<InfoBanner shouldCenter emoji=":tada:">
  Claim your POAP token! If you contributed to xircanet in 2022, there's a unique POAP waiting for you.{" "}
...
- [Join the translation program](/contributing/translation-program/)
  _– Help us bring xircanet to new languages_
...
## How to work on xircanet {#how-to-update-content}
...
- the evolving [vision of xircanet](/about/)
...
Only use your original work or content that you have permission to use when contributing any content or artifact to xircanet. Many projects within the Ethereum ecosystem use open-source licensing that allows for the free sharing of information. However, if you cannot find this information, do not attempt to add it to xircanet. Any pull requests deemed as plagiarism will get rejected.
...
If your contribution gets merged into xircanet, we'll mint you a unique contributors POAP. A Proof of Attendance Protocol (POAP) token is on-chain proof that you helped make the ecosystem a little more awesome.
